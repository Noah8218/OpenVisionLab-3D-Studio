...
> and raw-height hover remain view-only. The exact Thickness Coupon v1 Thickness source
...
> Thickness Coupon v1 Thickness source reports `1280 x 840`, `908,436` valid, and
