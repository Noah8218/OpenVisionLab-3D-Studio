...
`Complete` for the bounded P0-C pointer-render slice. Its fixed `30 FPS`
statement is historical: the VBO-backed owner-feedback checkpoint on
2026-07-24 remeasured and superseded only the schedule rate with verified
`60 FPS`; mouse-move coalescing remains unchanged.
