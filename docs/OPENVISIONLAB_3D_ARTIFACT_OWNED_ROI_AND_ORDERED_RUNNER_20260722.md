...
explicit Published A2 TransformedPointCloud
  ...
  -> Thickness, Warpage, Plane Flatness, Point Pair, and/or Gap/Flush in authored recipe order
...
- authored five-measurement order and aggregate status -> pass
...
- Runner --verify-artifact-owned-roi-runner -> 16/16
Evidence: artifacts/verification/20260722-generic-gap-flush/artifact-owned-runner.txt
Boundary / next dependency: sequence begins with an explicit Published A2 and supports only A3 followed by Thickness/Warpage/Plane Flatness/Point Pair/Gap/Flush. Real four-landmark A1/A2 data and arbitrary whole-graph replay are not proven. No automatic seam detection, physical calibration, or metrology claim.
```
