...
- Public `3D/PublicSamples/glTF/ToyCar.glb` ad-hoc probe passes Viewer/Shell GLB load, pick, and two-point measurement with 66,951 vertices, 88,837 triangles, 66,951 UVs, and embedded PNG texture evidence; it remains probe-only because it did not expose a new fixed-matrix gap.
