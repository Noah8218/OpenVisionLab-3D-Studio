...
public static class ToolRecipeTransformedHeightFieldMeasurementSequence
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var unsupported = downstream.FirstOrDefault(candidate => candidate.Step.ToolId is not ("thickness" or "warpage" or "plane-flatness" or "point-pair-dimensions" or "gap-flush" or "volume" or "cross-section-dimensions" or "completeness-grid" or "presence-check"));
