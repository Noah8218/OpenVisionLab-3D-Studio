...
namespace OpenVisionLab.ThreeD.Viewer.Verification;
    ...
    public static bool Verify(string reportPath, out string summary)
    {
        ...
        try
        {
            ...
            Check(
                ...
                && !viewModel.DecreaseC3DHeightColorMaximumCommand.CanExecute(null)
                && !viewModel.IncreaseC3DHeightColorMaximumCommand.CanExecute(null)
                && !viewModel.DecreaseC3DHeightColorMinimumCommand.CanExecute(null)
                && !viewModel.IncreaseC3DHeightColorMinimumCommand.CanExecute(null)
                && !viewModel.ResetC3DHeightColorRangeCommand.CanExecute(null),
            ...
            viewModel.IncreaseC3DHeightColorMinimumCommand.Execute(null);
            viewModel.DecreaseC3DHeightColorMaximumCommand.Execute(null);
            Check(
                ...
                viewModel.C3DHeightColorRangeSummary);
            viewModel.ResetC3DHeightColorRangeCommand.Execute(null);
            Check(
