...
public sealed partial class MainWindowViewModel
{
    internal void RefreshLocalizedPresentation()
    {
        ...
        [
            ...
            nameof(ImportedMeshLayerLabel),
            nameof(GlbSampleSummary),
            nameof(LazSampleSummary),
            nameof(SectionProfileSummary),
            nameof(SectionProfileRange),
            nameof(SelectionSummary),
            nameof(PointCloudColorLegendTitle),
            nameof(PointCloudColorLegendLow),
            nameof(PointCloudColorLegendHigh),
            nameof(PointCloudColorLegendScale),
            ...
            nameof(DeviationLegendStatus),
            nameof(DeviationLegendPeak),
            nameof(DeviationLegendTolerance),
            nameof(DeviationLegendScale),
