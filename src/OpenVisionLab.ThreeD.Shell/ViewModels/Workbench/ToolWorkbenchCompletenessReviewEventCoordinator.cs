...
/// <summary>
/// Owns the Completeness Review notification subscription and forwards
/// presentation changes to the Workbench facade.
/// </summary>
internal sealed class ToolWorkbenchCompletenessReviewEventCoordinator : IDisposable
{
    ...
    public ToolWorkbenchCompletenessReviewEventCoordinator(
