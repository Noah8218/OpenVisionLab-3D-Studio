...
/// <summary>
/// Owns the Displayed Outputs notification subscription and forwards
/// presentation changes to the Workbench facade.
/// </summary>
internal sealed class ToolWorkbenchDisplayedOutputsEventCoordinator : IDisposable
{
    ...
    public ToolWorkbenchDisplayedOutputsEventCoordinator(
