...
/// <summary>
/// Owns the Surface Match collection notification subscription and forwards
/// presentation changes to the Workbench facade.
/// </summary>
internal sealed class ToolWorkbenchSurfaceMatchCollectionEventCoordinator : IDisposable
{
    ...
    public ToolWorkbenchSurfaceMatchCollectionEventCoordinator(
