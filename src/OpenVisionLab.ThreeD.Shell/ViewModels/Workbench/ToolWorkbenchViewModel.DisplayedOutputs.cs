...
public sealed partial class ToolWorkbenchViewModel
{
    ...
    public ResettableObservableCollection<ToolWorkbenchDisplayedOutputItem> DisplayedOutputs { get; } = [];
    ...
    {
        DisplayedOutputs.ReplaceAll(ArtifactRegistry.Select(artifact => new ToolWorkbenchDisplayedOutputItem(artifact)));
