...
internal static class C3DLandmarkCorrespondenceGoldenVerification
{
    public static int Run(string reportPath)
    {
        var cases = new[]
        {
            ...
            Check("schema-1.3-recipe-adapter-and-roundtrip", VerifyStrictRecipeAdapterAndRoundtrip),
    ...
    private static (bool Passed, string Evidence) VerifyStrictRecipeAdapterAndRoundtrip()
    {
        ...
        try
        {
            ...
            return (prepared
                ...
                && rejected
                && reopened.SchemaVersion == ToolRecipeDocument.ArtifactOwnedSelectionSchemaVersion
