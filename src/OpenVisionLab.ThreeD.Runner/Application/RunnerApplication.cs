...
internal static class RunnerApplication
{
    ...
    internal static int RunToolRecipe(
        string recipePath,
    ...
    internal static int RunStlStreamProbe(string stlPath, string unit, string reportPath)
    {
        try
        {
    ...
    internal static int RunMeshDeviationParity(
    ...
    internal static string? ReadOption(IReadOnlyList<string> args, string name)
    {
    ...
    internal static int? ReadIntOption(IReadOnlyList<string> args, string name)
    {
