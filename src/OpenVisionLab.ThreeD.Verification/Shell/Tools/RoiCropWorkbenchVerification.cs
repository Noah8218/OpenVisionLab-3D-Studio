...
internal static class RoiCropWorkbenchVerification
{
    public static bool Verify(string reportPath, out string summary)
    {
        ...
        try
        {
            ...
            var hadRoiCropPreviewBeforeDispose =
                workbench.CurrentRoiCropPreviewOutput is not null;
            workbench.Dispose();
            workbench.Dispose();
            Check(
                "ROI / Crop disposal clears Preview state idempotently",
                hadRoiCropPreviewBeforeDispose
                && !workbench.IsRoiCropPreviewRunning
                && !workbench.HasCurrentRoiCropPreview
                && !workbench.IsRoiCropPreviewPublished
                ...
                $"before={hadRoiCropPreviewBeforeDispose};running={workbench.IsRoiCropPreviewRunning};current={workbench.HasCurrentRoiCropPreview};published={workbench.IsRoiCropPreviewPublished};preview={workbench.PreviewSelectedStepCommand.CanExecute(null)};publish={workbench.PublishSelectedStepCommand.CanExecute(null)};cancel={workbench.CancelSelectedPreviewCommand.CanExecute(null)}");
        }
