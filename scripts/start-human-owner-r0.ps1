...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "6E09CC113CD4A52CEABB207062431552A50249BB25251605AAA45DCB7408D3F4"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "0F75A53EA17570E8A13CDB5EAFCEAFEB4C67B0577D25CFB9B20DEE33FEB060F8"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "737D8289A40A27C0786FBEDDB0CD550789F628F842A242CC0EFA21A721F0136C"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "96F93E52314FF08F9956B5152FD2C9BDDF9F0B339C3ED595FFA4132F8AFCD5D6"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "D136D2A5D2FB4DF89514B8075005F2D388740D542CE4F1A038294B6029254F73"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "FC30B120D5DA0A7C85819FE8268CA07EF73CE58358C75BD57BDA0C5DFD479DEF"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "6939E69E0B87FF5A8DE8D8FA74E91C77B70A540DA1A8B282EFC0127EBF36D26A"
