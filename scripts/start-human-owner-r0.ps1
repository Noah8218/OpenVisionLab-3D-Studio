...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "85C23F9603318FDDD25A5B59F3E486430DF2A050FA83B6522CFE3FDA020B3D65"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "23AF54574960A0C650D589B4D0B3A0F7BE1AC08D2BE84680E7E83A1C6081D46B"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "7C906143CAD1CBF15846D7F541E74A61F6C63812A1EB27D96EAF93BD5830FCE5"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "835746BA6D1AA338B6EDB0FC506BC3DCC7A2CFE2397332793168E573A1E1BC3F"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "D470A66C7D2FE712F6E6C310B369630EBA5421CB7D29A3D4A1187D63D169D46F"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "24BF9B9FADE1084A84D9F9BCA535B14116677882534EE316C98446F6C7472310"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "22E1F697F7E62B8BC8BC0A3A3D37E95306E3D7758F8EAD39E8BDCBE9C3F0F8D1"
