...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "51589C44E833179D8D181AB5BB10FE4567661C20ACCFB31321AD2907856BC696"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "703F7148696980BE34871DC4D9668453B0094D561451D039A7CFF457C0C07833"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "F5CE88B9B2E43052D0660214A5EC9D16D608364CC26D4833218B9EAD0FC7D327"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "86A990D1D45D7E4E415235A6BA5ABC7D1E89C30173E3EE62F70679A5B3216BC5"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "AB3E8286D5B52DEA0506F77C24E6FCA514656DA503AC268632A35560968F66D6"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "685CAC6A5FBFFAF39D377F38EB9B14952D17A31FFCA4AC82A0A9D0813A690A3B"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "874EBD8C17FF81CB37BA3EC63DD2E6264FBC5ECB739261A5B50D8E2E4A8AB37D"
