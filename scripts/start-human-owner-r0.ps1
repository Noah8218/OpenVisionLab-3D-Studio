...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "398EF6BC81064120CE8BBB7221944B464BC788E72A840661683F64F9673B3129"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "86AAEDC1635205AC5599F84B516437272745D4B312CF8394DC9DF684C063C7F5"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "570995ED1B7353C6783D38902BB3555F53141DA42AAA3668B85414596A1288CE"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "94454ED8891FA86A6D2B25764D0DAD583CC0B032955EE82AC65486CE824E85CC"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "C0EECAC92156970B0606630A7F3950A0DB36818E7A9B895DD1310C5F8EC3C50C"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "E0AC9BE4A9B29F7E8896382B8DBB698C684A262C9E1600950C03C5F07E88DD51"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "28888151D636DE94EE43DD18D7577D7DDDA1401AA2A506BBBA8EF8ABEAFA40CE"
