...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "A3791ED6D86754C2447954F12A61F697721DE6E6F5EA8730960B95FD8BE8EDF6"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "E1F41EF37C05C2DED6D0389E346490B0F8C36059BA9CB0310B9A378802DA526B"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "EE7476F95F2D100299EADAFA3F39393475D1FB2AC6DDEDC7A6D74D627E8FF30B"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "E48E933B611B9E98A68306FBC6367E28FBD4BD1A374FA5C62A359DEA7A3F82E7"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "FF749F49EA687E86B9DD4CC29B8F637C3786B41DE3564BA5B5C4BC734754FF55"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "E5367FC847DA8A95341CFBFD082A1AE461941EFB33E22B52063DB7127C364376"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "312AE6158B12EAA399A0B7B56A2AAA4D60C1944EAAEFC5180D5B56C132F06573"
