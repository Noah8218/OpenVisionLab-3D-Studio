...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "172B515A54C7CAAD70D73766ADAB7970ED3476EF62EE76477C251B3233B17BA7"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "6A97BC470F6C0CF0716992B77A51F4778F0BA9078503B7E86F6C4177AEB7E2D7"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "09E720D2EEE8CAA7ACF5A63B60FE67EC28024D24C882A22D2E5E9ED96F625E61"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "74909AF7384657192200A8D84D3CB2F44AC2849416B4727240A1FD5D98908703"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "68F49F8713CD01C738AAB6F4CAC385696CFB165889CA2008BAE443A16E0B1EDF"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "3BA778B155E273018078B7947F48E9A6439D6EE668F630BF1FC9A27812A378A9"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "63E2E91A6468289EB9E9E8FEF85E7D9861D9505C80ADC164E32B69724EA83ADE"
