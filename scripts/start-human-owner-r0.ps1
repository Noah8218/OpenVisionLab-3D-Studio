...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "A7E123EC297125AFD7CE92102A02178334AD2BD74A55FE14B6E36F66F3196F94"
...
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "348B3F52BB05F5EDC74AD5143D65EF0DE7B5023D8F8678AC37A1BB9651691686"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "CD0E1984304207BF2C91E07FE256F3BD0EBB7D9148F9FF9BF11C9A1541908C16"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "BFAF62F214D5BEC5152DDDE40698DCC40E1198F160AE7A1689AE821C4C2776F8"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "065CBAF64A95A63E1ADDE1AF0F3A61BE12D8296849C8751A99DAF6BFF4EA3123"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "3DA89F6A711BFD8B624842511BFEC6444665EB34C89BE8F859619005F31EB860"
