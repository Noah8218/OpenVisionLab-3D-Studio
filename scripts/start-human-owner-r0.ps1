...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "5746DA5750534518A0E1FD67B37B48D5319819E305709479240476E096D09F9C"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "D243F5BF7D49F8DA7AA8EA8300693D43640420A9552B6F8AFE702650EF8C795C"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "B13D89372919E08EB82EEF53FCB4832B22BC8D43D69F6EAC02657A31205DD84F"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "7339F44B94813450E9981E632D5C0EE41896BC6CB79223EEEB5955EB07E9AA60"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "E15FD97F040A1CE0B7D8642CAF6243EE8E477170F0FFC18309B0FEC356C13738"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "ED7A61F39F96CE277C5151F6227453E8714A3B6E60570430B930E595249BB8F5"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "F8F5967F56C1F33488FB86C8E7CAD15392140528E6CFC0CFBB689CE8AAF3B6C9"
