...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "419941D12A7EEEA97D7C3653AD720BCC26E504A93FFFFCAA2880F46C203D0DF3"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "4FADA730211B945BAC68C084C723F03C799771B4EFEADCD6C3FB753A377EA051"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "8E1FDE184114FC7AEEA553F1769C0A2BB2D81D6CD22BFECCF725BF4266AE1167"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "7A03FE2C22E6DB14B935054EDACDAFD4F98126DE98FE54223F5705B7526DD219"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "61D72BAC66EAAEE2B0A1642F68EEEF642E16BC006ACD51719E3DDDBEF5E7BC82"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "314F97142CCC68FCE51FB2EFDF88991EFA974598ED220C9AA8858F4B2EA5E7AB"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "DCA3C5E0CB9583835B415D6260C6C958D080AFEBB7F48F00816132864B75AEDF"
