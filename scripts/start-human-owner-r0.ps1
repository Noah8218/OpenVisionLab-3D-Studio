...
$expectedHashes[(Resolve-Path -LiteralPath $shellExe).Path] =
    "24A15EC7091D8E000740B0917A7C5E7DCAC90C77BEB95D334CEC5C42B9DE6A53"
$expectedHashes[(Resolve-Path -LiteralPath $shellAssembly).Path] =
    "420DE588EF3B1A830FC9AB0A2708682D5ED2A270794A93A33016C1A585C38016"
$expectedHashes[(Resolve-Path -LiteralPath $coreAssembly).Path] =
    "D1F026B7D9B565A3E14B8D04CDC1A123BF00CB82C9DEB7BC8DB2BA735134500D"
$expectedHashes[(Resolve-Path -LiteralPath $dataAssembly).Path] =
    "4D22B3AF7FEC156968BBFBA18DCA5620D5D98532AEDC033160431D821566B09C"
$expectedHashes[(Resolve-Path -LiteralPath $toolsAssembly).Path] =
    "27A3A91D11B6CC7A3A7311BBC5E6CB322B0188EC3FEB3FFD9D62C737120D4DA9"
$expectedHashes[(Resolve-Path -LiteralPath $viewerAssembly).Path] =
    "CF3960E3CB0ACDFD37772E81AAE3E697725F27634FEA5CBF926831A2A27FA340"
$expectedHashes[(Resolve-Path -LiteralPath $dockingAssembly).Path] =
    "22603367A9C08BEE8B612D9BEA7733BD353FDBBB90BAD601C06ED51A55073637"
